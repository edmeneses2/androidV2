...
Mobile.verifyElementText(findTestObject('Parte2/Ajustes cuenta/Cuenta/Pin de Acceso/android.widget.TextView - Pin de acceso no corresponde'), 
    'Pin de acceso no corresponde')

Mobile.tap(findTestObject('Parte2/Ajustes cuenta/Cuenta/Pin de Acceso/android.widget.ImageButton'), 0, FailureHandling.STOP_ON_FAILURE)
