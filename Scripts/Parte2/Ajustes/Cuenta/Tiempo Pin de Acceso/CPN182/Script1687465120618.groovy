...
Mobile.tap(findTestObject('Parte2/Ajustes cuenta/Cuenta/Tiempo Pin de Acceso/android.widget.RadioButton - 1 da'), 0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Parte2/Ajustes cuenta/Cuenta/Tiempo Pin de Acceso/android.widget.TextView - Configuracin de cuenta'), 
    0)
