...
Mobile.tap(findTestObject('Parte2/Ajustes cuenta/Cuenta/Tiempo Pin de Acceso/android.widget.RadioButton - 1 minuto'), 
    0)
...
Mobile.verifyElementText(findTestObject('Parte2/Ajustes cuenta/Cuenta/Tiempo Pin de Acceso/android.widget.TextView - 1 minuto'), 
    '1 minuto')
